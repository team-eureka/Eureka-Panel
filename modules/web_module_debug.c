...
int web_module_debug(char *command)
{
    ...
    printf("<form id=\"form1\" name=\"form1\" method=\"get\" action=\"\" style=\"display: inline-block\" onsubmit=\"return confirm('This bypasses the staged rollout system. If an update causes problems you may need FlashCast to restore an older version of Eureka-ROM.\nDo you want to continue?');\"><button name=\"page\" type=\"submit\" id=\"page\" value=\"forceeurekaupdate\"  style=\"display: inline-block\">Force Update</button></form>\n");
